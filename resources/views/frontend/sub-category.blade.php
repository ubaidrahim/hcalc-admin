...
<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-end mb-3">
      <button class="btn btn-primary" id="btnAddCategory">+ Add Sub-Category</button>
    </div>
...
// Make editCategory and deleteCategory available globally
